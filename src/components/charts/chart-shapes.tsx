...
//
// **R-V10 — a chart inside a tile is furniture-free.** `bare` on the shape input drops the grid,
...
type ShapeInput = {
  ...
  /**
   * **R-V10 — a chart inside a tile carries no axes, no ticks, no grid and no legend.**
   *
 ...
 *
 * **`bare` drops everything but the tooltip** (R-V10). It is one branch here rather than a prop
 ...
 * decides whether a chart has axes, so R-V10 is assertable over the decision rather than over
