...
- **T-C9.2 — Money is one formatter, and a table column reads in its own unit** (A30, R-N15,
...
- **T-C9.3 — `Member.kind` reaches a reader as words** (A30). Component: no cell in the People
...
- **T-C12 — A chart inside a tile carries no furniture** (A29, R-V10). Asserted over
...
| A29 A tile chart carries no axis, tick, grid or legend | T-C12 |
| A30 One money formatter; no raw `Member.kind` enum on screen | T-C9.2, T-C9.3 |
